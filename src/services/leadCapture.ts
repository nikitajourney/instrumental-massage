...
const leadToFormSubmitPayload = (payload: LeadPayload) => ({
  ...
  price: `${payload.coursePrice} ₽`,
  personal_data_consent: payload.personalDataConsent ? 'Да' : 'Нет',
  advertising_consent: payload.advertisingConsent ? 'Да' : 'Нет',
  privacy_policy: 'https://instrument-massage.ru/privacy.html',
  personal_data_consent_text: 'https://instrument-massage.ru/consent-personal-data.html',
  advertising_consent_text: 'https://instrument-massage.ru/consent-advertising.html',
