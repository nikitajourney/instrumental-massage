...
export const Instructor: React.FC = () => {
  const instructorInfo = {
    ...
    description: 'Практикующий специалист по инструментальному массажу. Создал курс, объединяющий понятную теорию, технику безопасности и практические приемы работы со скребком.',
    bullets: [
