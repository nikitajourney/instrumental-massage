        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-6 sm:p-8 font-sans text-xs sm:text-sm text-graphite-300 leading-relaxed space-y-6 scrollbar-thin scrollbar-thumb-graphite-800 scrollbar-track-transparent">
              {activeTab === 'privacy' && (
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <p>
                      Оператором персональных данных является <strong>ИП КАТАЕВ ДМИТРИЙ СЕРГЕЕВИЧ</strong> (ИНН: 741518264009, ОГРНИП: 326745600021913). Мы уделяем приоритетное внимание конфиденциальности и безопасности ваших данных.
                    </p>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <p>
                      Пользователь дает согласие на обработку персональных данных путем проставления отдельной отметки в форме заявки. Мы используем HTTPS-соединение для защиты информации при ее передаче.
                    </p>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="p-4 bg-graphite-950 rounded-2xl border border-white/5 space-y-1 text-xs text-graphite-400 font-mono">
                      ...
                      <p>ОГРНИП: 326745600021913</p>
                      <p>Юридический адрес: 456315, Россия, Челябинская обл., г. Миасс, ул. Миасс-Золото, д. 2, кв. 1</p>
              ...
              {activeTab === 'refund' && (
                <div className="space-y-4">
                  <h4 className="text-base font-bold text-white mb-2">УСЛОВИЯ ВОЗВРАТА СРЕДСТВ</h4>
                  ...
                  <div className="space-y-3">
                    <h5 className="font-bold text-turquoise-400 text-xs uppercase tracking-wider">1. Общий порядок возврата</h5>
                    <p>
                      Заказчик вправе отказаться от услуги в порядке, предусмотренном законодательством РФ. Размер возврата зависит от момента обращения, объема уже предоставленного доступа и фактически понесенных Исполнителем расходов.
                    </p>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="p-3 bg-turquoise-500/5 rounded-xl border border-turquoise-500/10 text-turquoise-300">
                      Если доступ к основным материалам курса еще не предоставлен, возврат производится в полном объеме. После предоставления доступа сумма возврата определяется с учетом фактически оказанных услуг и документально подтвержденных расходов.
                    </p>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <p>
                      Денежные средства возвращаются тем же способом, которым была произведена оплата, либо иным согласованным способом, не позднее 10 дней со дня получения требования о возврате. Срок фактического зачисления зависит от банка и платежной системы.
                    </p>
                  </div>
                </div>
              )}
