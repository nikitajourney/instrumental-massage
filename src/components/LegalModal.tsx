                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="p-3 bg-graphite-950 rounded-xl border border-white/5 text-[12px] text-graphite-400 leading-relaxed font-mono">
                      <strong>Примечание о передаче данных в Telegram:</strong> Для обеспечения максимальной скорости обработки заявок администратором, отправленные Пользователем данные мгновенно и безопасно передаются посредством защищенных шифрованием API-протоколов в закрытый служебный Telegram-чат администратора курса. Никаким сторонним третьим лицам или рекламным сетям данные не передаются.
                    </p>
                  </div>
